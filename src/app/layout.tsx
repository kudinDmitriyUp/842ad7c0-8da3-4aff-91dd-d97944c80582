...
export const metadata: Metadata = {
  ...
  description: "Experience the perfect blend of innovation and simplicity with Apple's groundbreaking products designed for the modern world.",
  keywords: "apple, innovation, technology, design, minimalist, products, iphone, macbook, clean design",
  ...
  openGraph: {
    ...
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763147731990-7lzrz2rf.jpg",
      alt: "Apple minimalist design showcase"
    }]
  },
  twitter: {
    ...
    title: "Apple - Think Different",
    description: "Experience the perfect blend of innovation and simplicity with Apple's groundbreaking products designed for the modern world.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763147731990-7lzrz2rf.jpg"]
  },
  robots: {
    index: true,
    follow: true
